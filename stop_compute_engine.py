...
def stop_instance(credentials_json, project_id, carazone, instance_name):
    ...
    try:
        ...
        response = gce.stop(request)
        logging.info(f'Instance {instance_name} stopped successfully. Response: {response}')
...
if __name__ == "__main__":
    try:
        ...
        # Stop the instance 
        stop_instance(CREDENTIALS, project_id, zone, instance_name)
